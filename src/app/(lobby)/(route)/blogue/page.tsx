  ...
  return (
    <div className="container mx-auto p-6 text-center dark:bg-[#012737]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-y-8 gap-x-4 justify-items-center dark:bg-[#012737]">
        {blogPosts.map((post) => (
          <Link key={post.slug} href={`/blogue/${post.slug}`} className="block w-full max-w-md p-4 bg-white dark:bg-[#012737] dark:text-white rounded-lg shadow-lg hover:shadow-xl dark:shadow-white transition-shadow duration-300">
